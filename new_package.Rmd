...
The best instructions I've found are from [Eryk Walczak](https://walczak.org/2017/06/how-to-add-code-coverage-codecov-to-your-r-package/).
Note particularly that you have to copy the token to wherever you're pushing
your commits from.
